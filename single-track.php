...
?>
    ...
    <div class="main container mt-5">
        <div class="row">
            <main class="col">
                <h3 class="text-center">Трайк Оса </h3>
                ...
                <a href="images/osa01.jpg" target="_blank" title="посмотреть увеличенную фотографию">
                    <img src="images/osa01_mini.jpg" class="img-fluid mt-2" alt="парелет трайк оса">
                </a>
                <a href="images/osa02.jpg" target="_blank" title="посмотреть увеличенную фотографию">
                    <img src="images/osa02_mini.jpg" class="img-fluid mt-2" alt="паралет трайк оса">
                </a>
